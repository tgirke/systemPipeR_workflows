...
Rscript -e "rmarkdown::render('systemPipeRNAseq_single.Rmd', c('BiocStyle::html_document'), clean=F); knitr::knit('systemPipeRNAseq_single.Rmd', tangle=TRUE)"; Rscript ../md2jekyll.R systemPipeRNAseq_single.knit.md 12; Rscript -e "rmarkdown::render('systemPipeRNAseq_single.Rmd', c('BiocStyle::pdf_document'))"
-->
...
vim-r or RStudio) and run the workflow as outlined below. 
...
Also, the NGS reads of could be aligned against the reference
genome sequence using `Hisat2` [@KKim2015-ve]. The parameter 
settings of the aligner are defined in the `hisat2.param` file.
