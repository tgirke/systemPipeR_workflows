...
## genWorkenvir(workflow="rnaseq", url="https://raw.githubusercontent.com/dcassol/systemPipeR_Workflows/master/rnaseq/version-SingleMachine/systemPipeRNAseq_single.Rmd", urlname = "systemPipeRNAseq_single.Rmd")
## setwd("rnaseq")
